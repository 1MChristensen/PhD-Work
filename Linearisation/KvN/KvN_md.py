...
psi = kvn_md.psi0(x, y, x0, y0, type='gaussian', cov=0.03)

# Generate the Hamiltonian
H = kvn_md.KvN_Hamiltonian(x, y, mu, deriv_type='FD')
...
x_pred_length, y_pred_length = kvn_md.find_prediction_length(x_pred, y_pred, x_sol, y_sol, t)
